export const green2blue =
  'linear-gradient(149.62deg, #51DBA9 14.66%, #52BBB5 32.2%, #5451DB 86.31%);';
...
export const pink2blue = 'linear-gradient(168.67deg, #EB7179 14.66%, #8691F0 86.31%);';

const gradients = [green2blue, orange2pink, green2yellow, pink2blue];
