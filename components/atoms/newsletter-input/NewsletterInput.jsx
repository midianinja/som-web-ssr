...
import { Input, Icon, NewsletterInputWrapper, inputStyle } from './newsletterInput.style';
 ...
 */
function NewsletterInput({ onChange, placeholder, value, width, point, onSubmit }) {
  return (
