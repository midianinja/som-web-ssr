...
export const updateProductor = (id, productor) => client().mutate({
...
export const createLocation = location => client().mutate({
...
export const updateLocation = (id, location) => client().mutate({
