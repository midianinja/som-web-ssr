...
import {
  openModalKeyframes, openMObileModalKeyframes, Wrapper, Nav,
  Link, Logout, Terms, ExitButton,
...
const renderLinks = (user, connectionType, router) => getLinks(user, connectionType)
  .map(({ href, label, hide }, index) => (
    <Link
      key={index}
      type={connectionType}
      href={href}
