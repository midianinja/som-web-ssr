...
import {
  ArtistCurationshipModalWrapper, CloseWrapper, CloseIcon, ProfileImage,
  ArtistWrapper, ArtistInfos, ArtistName, Label,
  Empty, Bold, GreenBold, RedBold,
  ArtistDescription, ProfileLink, CoverWrapper, HeaderWrapper,
  Container, WhiteZone, ButtonsWrapper, aprroveButtonStyle,
  reproveButtonStyle, audioListStyle, resetSubscriptionStyle
            ...
            <HeaderWrapper>
              ...
              <ArtistWrapper>
                ...
                <ArtistInfos>
                  ...
                  <ProfileLink onClick={() => router.push(`/artist/${artist.id}`)}>Ver perfil completo</ProfileLink>
                </ArtistInfos>
              </ArtistWrapper>
            </HeaderWrapper>
          </Cover>
